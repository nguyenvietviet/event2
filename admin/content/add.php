            ...
            <div class="card-body">
               ...
               <div class="row">
                  <div class="col-md-6 mb-6">
                     ...
                     <input type="text" class="form-control" name="ddk" id="ipdd" style="width:300px;display:none;" placeholder="Nhập địa điểm...">              
                  </div>
                  <div class="col-md-6 mb-6" style="padding-top: 14px;">
                    <br>
               ...
               <div class="row">
                <div class="col-md-6 mb-6">
                     ...
                     <input type="text" class="form-control" name="nctk" id="ipNCT" style="width:300px;display:none;" placeholder="Nhập người chủ trì...">
                  </div>
               ...
               <div class="row">
                 <div class="col-md-6 mb-6">
                  ...
                  <input type="text" name="dvtck" class="form-control" id="ipdvtck" style="width:300px;display:none;" placeholder="Nhập đơn vị tổ chức...">
                  </div>
                  <div class="col-md-5 mb-6" style="padding-top: 14px;">
                    <br>
...
$('#output_DS').html($('#checkable-output').html());
  ...
  //$('#btn-update').click(function(){
    ...
    if(ngaytochuc==''|| tgbatdau==''||tgketthuc==''||diadiem==''||diadiem=='--Chọn địa điểm--'||nct==''||nct=='--Chọn người chủ trì--'||dvtc==''||dvtc=='--Chọn đơn vị tổ chức--'||noidung==''||(tptg.length==0&&tptgk=='')){
        ...
        formData.append("taikhoan", '<?=$taikhoan?>');
            $.ajax({
              ...
              success : function(data)  // Hàm thực thi khi nhận dữ liệu được từ server
                   { 
                        if(data=='File đã tồn tại!'||data=='Không được upload ảnh lớn hơn 10 (MB)!'||data=='Chỉ được upload các định dạng JPG, PNG, JPEG, GIF,XLS,XLSX,DOC,DOCX,PPT,PPTX,PDF,ZIP,RAR!'||data=='Có lỗi xảy ra khi upload file!'){
  ...
  if(bol==true){
        $.ajax({
         ...
         data : {ngaytochuc:ngaytochuc,tgbatdau:tgbatdau,tgketthuc:tgketthuc,diadiem:diadiem,nct:nct,dvtc:dvtc,noidung:noidung,thanhphan:thanhphan,tptg:tptg,ID_Taikhoan:<?=$ID_Taikhoan?>,file:file}, //dữ liệu sẽ được gửi
         success : function(data)  // Hàm thực thi khi nhận dữ liệu được từ server
                   { 
